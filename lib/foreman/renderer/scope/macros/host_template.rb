    ...
    module Scope
      module Macros
        module HostTemplate
          ...
          apipie :class, 'Host macros that will be executed on current host object' do
            name 'HostTemplate'
            property :host, String, desc: 'Current host object'
          end
          ...
          apipie :method, 'Returns a true if a parameter is considered truthy' do
            ...
            required :param_name, String, desc: 'name of the parameter'
            returns one_of: [true, false, ::Object], desc: 'true for truthy values, false for falsy values, or default_value when parameter with a given name was not found'
            raises error: HostUnknown, desc: 'when user asks for a parameter but host is available in rendering context.'
          ...
          apipie :method, 'Returns a false if a parameter is considered falsy' do
            desc "Parameters tends to be used in conditions. Users who set parameters tends to use
              ...
              Following values are considered falsy: false, f, no, n, off, 0"
            required :param_name, String, desc: 'name of the parameter'
            returns one_of: [true, false], desc: 'true for falsy values, false for truthy values, or default_value when parameter with a given name was not found'
            raises error: HostUnknown, desc: 'when user asks for a parameter but host is available in rendering context.'
          ...
          apipie :method, 'Returns a kickstart snippet for setting GRUB password for a host on bootloader line' do
            desc "GRUB password can be set for host either direcrly or for host group. The value is
              ...
              It returns empty string in case, GRUB is not set.
          ...
          apipie :method, 'Returns a kickstart snippet for setting a serial console' do

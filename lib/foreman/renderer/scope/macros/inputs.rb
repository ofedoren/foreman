    ...
    module Scope
      module Macros
        module Inputs
          ...
          apipie :method, 'Loads the information from input' do
            desc "Every template can be parametrized with inputs. Input needs to be explicitly defined
              ...
              corresponding value that was provided."

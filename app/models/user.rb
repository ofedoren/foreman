...
class User < ApplicationRecord
  ...
  apipie :class, desc: 'A class representing user object' do
    ...
    property :ssh_keys, array_of: SshKey, desc: 'Returns an array of SshKey object'
    property :ssh_authorized_keys, array_of: SshKey, desc: 'Returns an array of all the ssh authorized_keys'

...
All needed function and components are located at: `/react_app/components/common/table/index.js`  
To add select boxes to your foreman table please follow this steps:

## Connect The Reducer

Connect the `selectionReducer` from the table folder to your component
...
If you need the selection action for uses outside the table you can use import selection actions from the table.
Available actions:
...
The formatters are located at: `/react_app/components/common/table/formatters`
